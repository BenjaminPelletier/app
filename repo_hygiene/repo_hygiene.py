...
It will complete without error if no hygiene issues are found, or otherwise exit with an error.

It expects to be run from inside the repo_hygiene docker image via repo_hygiene.sh.
"""
